...
class Rule
{
	...
	function dispEditLinks($ruleNumber, $count, $up= 'up', $down= 'down', $del= 'del')
	{
		...
		if ($ruleNumber > 0) {
			?>
			<a href="conf.editor.php?<?php echo $up ?>=<?php echo $ruleNumber ?>" title="<?php echo _TITLE('Move up') ?>">
		...
		if ($ruleNumber < $count) {
			?>
			<a href="conf.editor.php?<?php echo $down ?>=<?php echo $ruleNumber ?>" title="<?php echo _TITLE('Move down') ?>">
		...
		?>
		<a href="conf.editor.php?<?php echo $del ?>=<?php echo $ruleNumber ?>" title="<?php echo _TITLE('Delete') ?>" onclick="return confirm('<?php echo $confirmMsg ?>')">
			<input type="button" value="X" /></a>
		<?php
		if ($this->cat != 'Comment') {
			?>
			<a href="conf.editor.php?comment=<?php echo $ruleNumber ?>" title="<?php echo _TITLE('Comment') ?>">
				<input type="button" value="C" /></a>
			<a href="conf.editor.php?separate=<?php echo $ruleNumber ?>" title="<?php echo _TITLE('Separate') ?>">
			...
			?>
			<a href="conf.editor.php?uncomment=<?php echo $ruleNumber ?>" title="<?php echo _TITLE('Uncomment') ?>">
